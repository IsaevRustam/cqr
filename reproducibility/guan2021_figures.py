"""
Local CQR vs Global CQR on heteroscedastic synthetic settings.
...
def main():
    ...
    parser.add_argument("--output",  type=str, default=None,
                        help="Output PDF/PNG path (default: figures/synthetic_fig.pdf)")
    ...
    if args.output:
        ...
        output = os.path.join("figures", f"synthetic_fig_h{h_str}.pdf")
